...
hiddenimports = [
    # xtray backend and config
    "xtray.backend_jsonrpc",
    "xtray.api",
    "xtray.cli",
    "xtray.ha_mqtt",
    ...
    "xtray.updater",
    "xtray.services",
    "xtray.services.display",
    "xtray.services.hotkeys",
    "xtray.services.network",
    "xtray.core",
    ...
    # computer_manager service layer and GUI launch target
    "computer_manager",
    ...
    # network_manager production modules and GUI launch target
    "network_manager",
