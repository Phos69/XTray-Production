...
class XTrayBackend:
    ...
    def __init__(
        ...
        *,
        ...
        self._handlers: dict[str, Handler] = {
            ...
            "display.set_ha_volume": self._set_display_ha_volume,
            "display.set_ha_muted": self._set_display_ha_muted,
            ...
            "updates.releases": self._updates_releases,
            "updates.download_install": self._updates_download_install,
            "updates.install": self._updates_install,
        }
    ...
    def _set_display_ha_volume(self, params: Mapping[str, Any]) -> int:
        return self.display_service.set_ha_entity_volume_percent(
            _required_str(params, "entity_id"),
            _bounded_percent(params.get("percent")),
        )

    def _set_display_ha_muted(self, params: Mapping[str, Any]) -> bool:
        return self.display_service.set_ha_entity_muted(
            _required_str(params, "entity_id"),
            _bool_param(params, "muted"),
        )
    ...
    def _updates_releases(self, params: Mapping[str, Any]) -> list[updater.UpdateInfo]:
        return updater.list_available_updates(
            include_prereleases=bool(params.get("include_prereleases", False))
        )
    ...
    def _updates_install(self, params: Mapping[str, Any]) -> dict[str, Any]:
        installer = Path(_required_str(params, "installer"))
        helper = updater.start_update_installer(installer)
        return {"installer": str(installer), "helper": str(helper)}
