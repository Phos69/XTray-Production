...
_OBSOLETE_DEFAULT_ICONS: dict[tuple[str, str], str] = {
    ("media.audio_output", "mdi:audio-input-rca"): "mdi:volume-high",
}
...
def normalize_tray_action_icons(value: Any) -> dict[str, dict[str, str]]:
    ...
    for action_id, default in defaults.items():
        ...
        icon = _OBSOLETE_DEFAULT_ICONS.get((action_id, icon), icon)
